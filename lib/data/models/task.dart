...
class Task extends HiveObject {
  ...
  RecurrenceRule get effectiveRecurrenceRule {
    return recurrenceRule ?? RecurrenceRule.fromLegacy(
      recurringPattern,
...
class TaskAdapter extends TypeAdapter<Task> {
  ...
  Task read(BinaryReader reader) {
    ...
    return Task(
      ...
      customCategoryId: fields[22] as String?,
      recurrenceRule: fields[23] as RecurrenceRule?,
      reminders: (fields[24] as List?)?.whereType<ReminderRule>().toList() ?? [],
    );
  }
