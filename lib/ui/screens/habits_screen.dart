...
class _AddHabitDialogState extends State<_AddHabitDialog> {
  ...
  void initState() {
    ...
    if (h != null) {
      ...
      _reminders = List<ReminderRule>.from(h.reminders);
          ...
          onPressed: () async {
            ...
            if (widget.habit == null) {
              await state.addHabit(
                ...
                iconIndex: _iconIndex, colorValue: AppColors.habitColorPalette[_colorIndex].toARGB32(), goalId: _goalId, reminders: _reminders,
              );
            } else {
              ...
              habit.reminders = List<ReminderRule>.from(_reminders);
